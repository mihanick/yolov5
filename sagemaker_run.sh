...
#python train.py --img 512 --batch 16 --epochs 200 --data dwg.yaml --exist-ok --weights yolov5x.pt
# python train.py --img 512 --batch 24 --epochs 200 --data dwg.yaml  --exist-ok --weights yolov5m.pt
python train.py --img 512 --batch 128 --epochs 200 --data dwg.yaml --exist-ok --weights yolov5s.pt 
