...
import numpy as np
from utils.plots import output_to_target, plot_images, plot_one_image
    ...
    with torch.no_grad():
        ...
        for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
            ...
            if plots and batch_i < 3:
                ...
                Thread(target=plot_images, args=(img, trg, paths, f, names, batch_size * imgsz, batch_size, 1, conf_thres), daemon=True).start()
